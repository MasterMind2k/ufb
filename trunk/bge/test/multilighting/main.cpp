...
int main(int argc, char** argv)
{
  ...
  BGE::Canvas::canvas()->light("First light")->setLinearAttenuation(0.01);
  ...
  BGE::Canvas::canvas()->light("Second light")->setLinearAttenuation(0.01);
  ...
  BGE::Canvas::canvas()->light("Third light")->setLinearAttenuation(0.01);
  ...
  BGE::Canvas::canvas()->light("Fourth light")->setLinearAttenuation(0.01);
  ...
  BGE::Canvas::canvas()->light("Fifth light")->setLinearAttenuation(0.01);
